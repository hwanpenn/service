            ...
            A = function(i) {
                ...
                w && !i && w.hide(),
                    ...
                    A.index = t.open({
                        ...
                        resize: !1,
                        area: ["182px", "50px"],
                        content: '<img id="layui-layim-min" src="' + a.avatar + '"><span id="mytempid">' + a.name + "</span>",
            ...
            ei = {
                ...
                chatLog: function(i) {
                    ...
                    return j.base.chatLog ? (t.close(ei.chatLog.index), ei.chatLog.index = t.open({
                        ...
                        content: j.base.chatLog + "?" + "channel=" + tenantId + "&toUserName=" + toUserName + "&fromUserName=" + fromUserName + "&toUserId=" + toUserId + "&fromUserId=" + fromUserId + "&id=" + a.data.id + "&type=" + a.data.type
                    })) : t.msg("未开启更多聊天记录")
                },
